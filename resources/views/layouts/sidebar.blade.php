@php
    ...
    // Entrée « Secteurs » : seulement si au moins un secteur est accessible (admins : tous).
    $secteursLink = ($user && $user->secteursAccessibles()->isNotEmpty()) ? [[
...
<aside class="w-[200px] shrink-0 bg-sidebar-bg border-r border-sidebar-border flex flex-col">
    ...
    <div class="px-4 py-5 border-b border-sidebar-border flex items-center gap-2.5">
        ...
        <div class="font-semibold text-[13px] text-ink-on-dark leading-none">cAIman</div>
    </div>
